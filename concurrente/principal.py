...
lbl1 = tkinter.Label(ventana, text= "COCINERO 1", font="Helvetica 18")
lbl1.pack()
lbl1.place(relx=0.08, rely=0.55)
lbl_cocinero1 = tkinter.Label(ventana, text= "Preparando:", font="Helvetica 18")
lbl_cocinero1.pack()
lbl_cocinero1.place(relx=0.30, rely=0.55)

lbl2 = tkinter.Label(ventana, text= "COCINERO 2", font="Helvetica 18")
lbl2.pack()
lbl2.place(relx=0.08, rely=0.70)
lbl_cocinero2 = tkinter.Label(ventana, text= "Preparando:", font="Helvetica 18")
lbl_cocinero2.pack()
lbl_cocinero2.place(relx=0.30, rely=0.70)

lbl3 = tkinter.Label(ventana, text= "COCINERO 3", font="Helvetica 18")
lbl3.pack()
lbl3.place(relx=0.08, rely=0.85)
lbl_cocinero3 = tkinter.Label(ventana, text= "Preparando:", font="Helvetica 18")
lbl_cocinero3.pack()
lbl_cocinero3.place(relx=0.30, rely=0.85)
ventana.mainloop()